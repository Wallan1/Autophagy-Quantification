...
```{r}
testdata=read.csv(file="~/Desktop/analysis_20Aug20/LC3-LAMP_analysis/20Aug20_analysis-NSW3005_basal.csv",header=TRUE)
testdata$BvsS<-"Basal"
testdata$Rep<-3
nobs=nrow(testdata)
for (i in 1:nobs) {
...
testdata2=read.csv(file="~/Desktop/analysis_20Aug20/LC3-LAMP_analysis/20Aug20_analysis-NSW3005_starved.csv",header=TRUE)
