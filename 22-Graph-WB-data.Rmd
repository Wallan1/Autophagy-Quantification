...
```{r}
WBdata$type<-factor(WBdata$type, levels=c("WT", "Control", "tepsin", "AP4E1"))
WBdata$BvsS<-factor(WBdata$BvsS, levels=c("Basal", "Starved"))
library(ggplot2)
...
tiff(file="~/Desktop/analysis_20Aug20/WB-quant/plots/WB-combined_LC3ratio.tiff",width=3000,height=2800,res=600)
plotme(WBdata_nodup$LC3ratioAve,WBdata_nodup$LC3ratioSD, expression("Normalized LC3 II/I (A.U.)"),"LC3 II/I ratio")
dev.off()

tiff(file="~/Desktop/analysis_20Aug20/WB-quant/plots/WB-combined_tepsinKD.tiff",width=3000,height=2800,res=600)
