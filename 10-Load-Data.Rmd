...
*change replicate #*
```{r}
testdata=read.csv(file="~/Desktop/analysis_20Aug20/nuclei-counts/NSW3001_cell-count_basal_20Aug20.csv",header=TRUE)
testdata$BvsS<-"Basal"
testdata$Rep<-2
nobs=nrow(testdata)
for (i in 1:nobs) {
...
testdata2=read.csv(file="~/Desktop/analysis_20Aug20/nuclei-counts/NSW3001_cell-count_starved_20Aug20.csv",header=TRUE)
