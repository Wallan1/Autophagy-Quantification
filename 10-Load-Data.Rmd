...
*change replicate #*
```{r}
testdata=read.csv(file="~/Desktop/Batch-eqNum_results_10Jun20/21Feb20_basal_eqNum_20Jun20.csv",header=TRUE)
testdata$BvsS<-"Basal"
testdata$Rep<-1
nobs=nrow(testdata)
for (i in 1:nobs) {
...
testdata2=read.csv(file="~/Desktop/Batch-eqNum_results_10Jun20/21Feb20_starved_eqNum_20Jun20.csv",header=TRUE)
