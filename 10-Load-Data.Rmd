...
*change replicate #*
```{r}
testdata=read.csv(file="~/Desktop/eqNum-results_LAMP-PCC_1Jul20/21Feb20_eqCellSum-PCC_basal_1Jul20.csv",header=TRUE)
testdata$BvsS<-"Basal"
testdata$Rep<-1
nobs=nrow(testdata)
for (i in 1:nobs) {
...
testdata2=read.csv(file="~/Desktop/eqNum-results_LAMP-PCC_1Jul20/21Feb20_eqCellSum-PCC_starved_1Jul20.csv",header=TRUE)
