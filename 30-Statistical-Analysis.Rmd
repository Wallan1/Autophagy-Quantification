...
U-Test of object counts, for nonparametric distributions
```{r}
...
U-Test of object counts, for nonparametric distributions
```{r}
wilcox_test(data=temp[which(temp$Type=="WT"),], LC3VolMinMax~BvsS, paired = FALSE)
...
dunn_test(LC3VolMinMax~Type, data=temp[temp$BvsS == "Basal",], p.adjust.method = "bonferroni")
...
dunn_test(LC3IntMinMax~Type, data=temp[temp$BvsS == "Basal",], p.adjust.method = "bonferroni")
...
dunn_test(LC3SumIntMinMax~Type, data=temp[temp$BvsS == "Basal",], p.adjust.method = "bonferroni")
...
dunn_test(LC3totIntMinMax~Type, data=temp[temp$BvsS == "Basal",], p.adjust.method = "bonferroni")
...
dunn_test(LAMPVolMinMax~Type, data=temp[temp$BvsS == "Basal",], p.adjust.method = "bonferroni")
...
dunn_test(LAMPIntMinMax~Type, data=temp[temp$BvsS == "Basal",], p.adjust.method = "bonferroni")
...
dunn_test(LAMPSumIntMinMax~Type, data=temp[temp$BvsS == "Basal",], p.adjust.method = "bonferroni")
...
dunn_test(LAMPtotIntMinMax~Type, data=temp[temp$BvsS == "Basal",], p.adjust.method = "bonferroni")
...
summary(KW_LC3VolMMb)
dunn_test(LC3VolMinMax~Type, data=temp[temp$BvsS == "Starved",], p.adjust.method = "bonferroni")
...
summary(KW_LC3IntMMb)
dunn_test(LC3IntMinMax~Type, data=temp[temp$BvsS == "Starved",], p.adjust.method = "bonferroni")
...
summary(KW_LC3SumIntMMb)
dunn_test(LC3SumIntMinMax~Type, data=temp[temp$BvsS == "Starved",], p.adjust.method = "bonferroni")
...
summary(KW_LC3totIntMMb)
dunn_test(LC3totIntMinMax~Type, data=temp[temp$BvsS == "Starved",], p.adjust.method = "bonferroni")
...
summary(KW_LAMPVolMMb)
dunn_test(LAMPVolMinMax~Type, data=temp[temp$BvsS == "Starved",], p.adjust.method = "bonferroni")
...
summary(KW_LAMPIntMMb)
dunn_test(LAMPIntMinMax~Type, data=temp[temp$BvsS == "Starved",], p.adjust.method = "bonferroni")
...
summary(KW_LAMPSumIntMMb)
dunn_test(LAMPSumIntMinMax~Type, data=temp[temp$BvsS == "Starved",], p.adjust.method = "bonferroni")
...
summary(KW_LAMPtotIntMMb)
dunn_test(LAMPtotIntMinMax~Type, data=temp[temp$BvsS == "Starved",], p.adjust.method = "bonferroni")
```
