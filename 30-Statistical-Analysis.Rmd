...
for (i in 1:ntemp) {
  if (temp[i,7]=="Basal") {
anovaBLC3Counts<-aov(temp$LC3PunctaCount~temp$Type*temp$Rep)


anovaBLC3CountsMM<-aov(temp$LC3CountMinMax~temp$Type*temp$Rep)

  }
  else {
anovaSLC3Counts<-aov(temp$LC3PunctaCount~temp$Type*temp$Rep)


anovaSLC3CountsMM<-aov(temp$LC3CountMinMax~temp$Type*temp$Rep)

  }
}

summary(anovaBLC3Counts)
TukeyHSD(anovaBLC3Counts)

summary(anovaBLC3CountsMM)
TukeyHSD(anovaBLC3CountsMM)

summary(anovaSLC3Counts)
TukeyHSD(anovaSLC3Counts)

summary(anovaSLC3CountsMM)
TukeyHSD(anovaSLC3CountsMM)
```
