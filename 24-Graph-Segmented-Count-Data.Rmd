...
plotme<-function(dat,yaxis,labelme,mytitle){
   ggplot(dat,aes(x=Type,y=yaxis,fill=Type, pattern=BvsS)) + 
    ...
    aes(),width=0.7,position = position_dodge(0.9),outlier.shape=NA, alpha=0.5,
     ...
     ggtitle(mytitle)+
     theme_minimal()+
     scale_y_continuous(name=labelme,limits = c(0,20000000))+
...
#tiff(file="~/Desktop/21Jan21_analysis/final/graphs/LC3PunctaCounts_boxplot_rep1-3_zoom0-200_15Feb21.tiff",width=3000,height=3000,res=600)
