...
plotme<-function(dat,yaxis,labelme,mytitle){
   ggplot(dat,aes(x=Type,y=yaxis,fill=Type, pattern=BvsS)) + 
    ...
    aes(),width=0.7,position = position_dodge(0.9),outlier.shape=NA, alpha=0.5,
     ...
     ggtitle(mytitle)+
     theme_minimal()+
     scale_y_continuous(name=labelme,limits = c(0,0.4))+
     theme(plot.title=element_text(hjust=.5))+
        scale_fill_viridis(discrete=TRUE,end=.9) +
        scale_color_viridis(discrete=TRUE,end=.9)+
        scale_pattern_manual(values = c(Basal = "none", Starved = "stripe"))
...
#tiff(file="./Analysis-files/eqCellsum_analysis/graphs/LC3PunctaVol_boxplot_combined-MM_31May21.tiff",width=4500,height=3000,res=600)
#plotme(temp,temp$LC3VolMinMax, expression("LC3 Puncta Volume (um"^'3'*")"),"Min/Max: Average Volume of LC3 Puncta")
#dev.off()

#tiff(file="./Analysis-files/eqCellsum_analysis/graphs/AveLC3Int_boxplot_combined-raw_31May21.tiff",width=4500,height=3000,res=600)
#plotme(temp,temp$AveLC3IntPerCell, "Average LC3 puncta intensity (A.U.)","Raw-all: Average LC3 Puncta Intensity")
#dev.off()

#tiff(file="./Analysis-files/eqCellsum_analysis/graphs/AveLC3Int_boxplot_combined-MM_31May21.tiff",width=4500,height=3000,res=600)
...
tiff(file="./Analysis-files/eqCellsum_analysis/graphs/AveLC3SumInt_boxplot_combined-MM_scale-adj_31May21.tiff",width=4500,height=3000,res=600)
plotme(temp,temp$LC3SumIntMinMax, "Average  LC3 puncta sum intensity (A.U.)","Min/Max: Average LC3 Puncta Sum Intensity")
dev.off()

#tiff(file="./Analysis-files/eqCellsum_analysis/graphs/TotLC3Int_boxplot_combined-raw_31May21.tiff",width=4500,height=3000,res=600)
#plotme(temp,temp$TotLC3IntPerCell, "Total LC3 puncta intensity (A.U.)","Raw-all: LC3 Puncta Sum Intensity per Cell")
#dev.off()

#tiff(file="./Analysis-files/eqCellsum_analysis/graphs/TotLC3Int_boxplot_combined-MM_31May21.tiff",width=4500,height=3000,res=600)
...
#tiff(file="./Analysis-files/eqCellsum_analysis/graphs/LAMPVol_boxplot_combined-MM_31May21.tiff",width=4500,height=3000,res=600)
...
#tiff(file="./Analysis-files/eqCellsum_analysis/graphs/AveLAMPInt_boxplot_combined-MM_31May21.tiff",width=4500,height=3000,res=600)
...
#tiff(file="./Analysis-files/eqCellsum_analysis/graphs/AveLAMPSumInt_boxplot_combined-MM_31May21.tiff",width=4500,height=3000,res=600)
...
#tiff(file="./Analysis-files/eqCellsum_analysis/graphs/TotLAMPInt_boxplot_combined-MM_31May21.tiff",width=4500,height=3000,res=600)
