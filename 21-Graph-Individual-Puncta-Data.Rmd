...
plotme<-function(dataset,yaxis,labelme,mytitle,nameme){
  ...
  #scale_x_continuous(name=labelme,limits = c(2,25))+
...
#tiff(file="~/Desktop/analysis_20Aug20/LC3-LAMP_analysis/cleaned_9Sep20/graphs/LC3MeanObjIntensity_NSW3005-dataset_9Sep20.tiff",width=2800,height=2800,res=600)
plotme(temp,temp$LC3MeanObjIntensity,"puncta mean intensity (A.U.)","LC3 Puncta Mean Intensity")
#dev.off()

#tiff(file="~/Desktop/analysis_20Aug20/LC3-LAMP_analysis/cleaned_9Sep20/graphs/LC3punctaVol_NSW3005-dataset_9Sep20.tiff",width=3000,height=3000,res=600)
plotme(temp,temp$LC3Volume,expression("LC3 Puncta Volume (um"^'3'*")"),"LC3 Puncta Volumes")
#dev.off()

#tiff(file="~/Desktop/analysis_20Aug20/LC3-LAMP_analysis/cleaned_9Sep20/graphs/LC3punctaVol_NSW3005-logScale-dataset_9Sep20.tiff",width=3000,height=3000,res=600)
plotme(temp,temp$LogLC3Volume,expression("LC3 Puncta Volume (um"^'3'*")"),"LC3 Puncta Volumes")
#dev.off()

#tiff(file="~/Desktop/analysis_20Aug20/LC3-LAMP_analysis/cleaned_9Sep20/graphs/LAMP1IndVol_NSW3005-dataset_9Sep20.tiff",width=3000,height=3000,res=600)
plotme(temp,temp$LAMP1Volume,expression("LAMP1 Puncta Volume (um"^'3'*")"),"LAMP1 Puncta Volumes")
#dev.off()

#tiff(file="~/Desktop/analysis_20Aug20/LC3-LAMP_analysis/cleaned_9Sep20/graphs/LAMP1MeanObjIntensity_NSW3005-dataset_9Sep20.tiff",width=3000,height=3000,res=600)
plotme(temp,temp$LAMP1MeanObjIntensity,"puncta mean intensity (A.U.)","LAMP1 Puncta Mean Intensity")
#dev.off()

#tiff(file="~/Desktop/analysis_20Aug20/LC3-LAMP_analysis/cleaned_9Sep20/graphs/MandersLC3MOC_NSW3005-dataset_9Sep20.tiff",width=3000,height=3000,res=600)
...
plotme(temp$MandersLC3MOC,expression("Manders' Overlap Coefficient"),"LC3/LAMP1 co-occurence")
#dev.off()
