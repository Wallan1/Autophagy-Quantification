...
#tiff(file="~/Desktop/23Jul20_MOC_results/batch-graphs/LC3meanInt_21Feb20-dataset_1Jul20.tiff",width=2800,height=2800,res=600)
#plotme(temp,temp$LC3MeanObjIntensity,"puncta mean intensity (A.U.)","LC3 Puncta Mean Intensity")
#dev.off()

#tiff(file="~/Desktop/analysis_20Aug20/LC3-LAMP_analysis/cleaned_9Sep20/graphs/LC3punctaVol_combined-dataset_9Sep20.tiff",width=3000,height=3000,res=600)
plotme(temp,temp$LC3Volume,expression("LC3 Puncta Volume (um"^'3'*")"),"LC3 Puncta Volumes")
dev.off()

#tiff(file="~/Desktop/analysis_20Aug20/LC3-LAMP_analysis/cleaned_9Sep20/graphs/LC3punctaVol_combined-logScale-dataset_9Sep20.tiff",width=3000,height=3000,res=600)
...
#-=tiff(file="~/Desktop/23Jul20_MOC_results/batch-graphs/MOCvalues_21Feb20-dataset-run2_23Jul20.tiff",width=3000,height=3000,res=600)
