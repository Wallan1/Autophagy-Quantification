...
plotme<-function(dataset,yaxis,labelme,mytitle,nameme){
  ...
  ggtitle(mytitle)+
  theme()+
  scale_x_continuous(name=labelme,limits = c(2,20))+
...
tiff(file="~/Desktop/analysis_20Aug20/LC3-LAMP_analysis/graphs/LC3punctaVol_combined-zoom2-20-dataset_20Aug20.tiff",width=3000,height=3000,res=600)
