...
#tiff(file="~/Desktop/analysis_20Aug20/LC3-LAMP_analysis/graphs/LC3punctaVol_combinedr2-4-dataset_naturalLog-scale_27Aug20.tiff",width=3000,height=3000,res=600)
plotme(temp,temp$LC3Volume,expression("LC3 Puncta Volume (um"^'3'*")"),"LC3 Puncta Volumes")
#dev.off()

#tiff(file="~/Desktop/analysis_20Aug20/LC3-LAMP_analysis/graphs/LC3punctaVol_combinedr2-4-dataset_Log-scale_27Aug20.tiff",width=3000,height=3000,res=600)
