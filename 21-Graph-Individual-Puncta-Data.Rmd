...
plotme<-function(dataset,yaxis,labelme,mytitle,nameme){
  ...
  ggtitle(mytitle)+
  theme()+
  #scale_x_continuous(name=labelme,limits = c(0.4,1))+
...
#tiff(file="~/Desktop/23Jul20_MOC_results/batch-graphs/LC3punctaVol_21Feb20-dataset-run2_23Jul20.tiff",width=3000,height=3000,res=600)
