...
```{r}
testdata=read.csv(file="~/Desktop/EqCellSum_22Feb21/Final/NSW3010_EqCellSum_Basal_count_18Mar21.csv",header=TRUE)
testdata$BvsS<-"Basal"
testdata$Rep<-3
nobs=nrow(testdata)
for (i in 1:nobs) {
...
testdata2=read.csv(file="~/Desktop/EqCellSum_22Feb21/Final/NSW3010_EqCellSum_Starved_count_18Mar21.csv",header=TRUE)
