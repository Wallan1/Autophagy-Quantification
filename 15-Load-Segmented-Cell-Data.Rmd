...
```{r}
testdata=read.csv(file="~/Desktop/21Jan21_analysis/final/NSW3016_Basal_count_15Feb21.csv",header=TRUE)
testdata$BvsS<-"Basal"
testdata$Rep<-3
nobs=nrow(testdata)
for (i in 1:nobs) {
...
testdata2=read.csv(file="~/Desktop/21Jan21_analysis/final/NSW3016_Starved_count_15Feb21.csv",header=TRUE)
