...
```{r}
testdata=read.csv(file="~/Desktop/EqCellSum_22Feb21/NSW3010_EqCellSum_Basal_count_22Feb21.csv",header=TRUE)
testdata$BvsS<-"Basal"
testdata$Rep<-1
nobs=nrow(testdata)
for (i in 1:nobs) {
...
testdata2=read.csv(file="~/Desktop/EqCellSum_22Feb21/NSW3010_EqCellSum_Starved_count_22Feb21.csv",header=TRUE)
