...
*change input file path*
```{r}
testdata=read.csv(file="./Analysis-files/eqCellsum_analysis/NSW3010_EqCellSum_Basal_Vol-Int_24Feb21.csv",header=TRUE)
testdata$BvsS<-"Basal"
testdata$Rep<-1
nobs=nrow(testdata)
for (i in 1:nobs) {
...
testdata2=read.csv(file="./Analysis-files/eqCellsum_analysis/NSW3010_EqCellSum_Starved_Vol-Int_23Feb21.csv",header=TRUE)
testdata2$BvsS<-"Starved"
testdata2$Rep<-1
nobs=nrow(testdata2)
for (i in 1:nobs) {
