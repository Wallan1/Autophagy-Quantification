...
```{r}
testdata=read.csv(file="~/Desktop/21Jan21_analysis/NSW3010_Basal_Vol-Int_1Feb21.csv",header=TRUE)
testdata$BvsS<-"Basal"
testdata$Rep<-1
nobs=nrow(testdata)
for (i in 1:nobs) {
...
testdata2=read.csv(file="~/Desktop/21Jan21_analysis/NSW3010_Starved_Vol-Int_1Feb21.csv",header=TRUE)
